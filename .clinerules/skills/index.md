...
## PROJECT CONTEXT
- **Type**: Agent
- **Tech Stack**: fastapi, openai, perplexity, websocket, uvicorn, gitpython, chrome, mcp
- **Domain**: AI-powered code analysis, bug detection, and improvement agent – Chrome extension + FastAPI backend....
...
Load skills from codereview-agent-skills.md

### In OpenClaw
```bash
/skills load codereview-agent-skills.md
```
